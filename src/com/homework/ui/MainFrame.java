				...
				try {
					...
					frame.addWindowListener(new WindowAdapter() {
						...
						public void windowClosing(WindowEvent e) {
							...
							System.out.println("the windows is closing");
...
//											Image.SCALE_DEFAULT);
							...
							g.drawImage(image,0,0,img.getWidth(null),img.getHeight(null),null);
							g.dispose();
							String savePath=filePath+"\\recImg.jpg";
