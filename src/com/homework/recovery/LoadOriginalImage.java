...
public class LoadOriginalImage implements JPEGDecoder.PixelArray {
	...
	private static final String SAVEDATANAME = "C:\\Users\\wenxiaofei-PC\\Desktop\\wen.xls";
	// 该常量是指要保存解析出来的jpg图片信息的文件路径
	public static final String JPGFILEINFO = "C:\\Users\\wenxiaofei-PC\\Desktop\\info.txt";
	private int[] pix;
